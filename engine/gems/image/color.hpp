...
class RandomColors {
 public:
  static RandomColors Default256() { return RandomColors(256, 1331); }

  RandomColors(size_t count, size_t seed) : colors_(count) {
...
void ColorizeIndices(const ImageConstView<Index, 1>& indices, const RandomColors& colors,
                     Image3ub& result) {
