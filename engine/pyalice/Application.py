...
class Application(object):
    ...
    def __init__(self, app_filename):
        self.app = PybindApplication(app_filename);
    ...
    def register(self, node_pycodelet_map):
        ...
        for name, pycodelet_class in node_pycodelet_map.items():
            ...
            node = self.app.findNodeByName(name)
            assert node.isValid(), "Node not found in Isaac graph"
    ...
    def find_node_by_name(self, name):
        ...
        return self.app.findNodeByName(name)
