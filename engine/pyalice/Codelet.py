...
class Codelet(object):
  ...
  """
    ...
    def get_isaac_param(self, param_name):
        return json.loads(self.__backend.bridge.get_config())[param_name]

    def set_isaac_param(self, param_name, param_value):
        params = json.loads(self.__backend.bridge.get_config())
        params[param_name] = param_value
        self.__backend.bridge.set_config(json.dumps(params))
