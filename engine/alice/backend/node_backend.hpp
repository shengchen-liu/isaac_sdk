...
class NodeBackend {
 public:
  ...
  // certain fields and among them is one called 'componetns'. This is an array itself where
  ...
  //     ]
  //   },
  void createNodeFromJson(const nlohmann::json& node_json, const std::string& prefix = "");
  // Stores the current node graph to JSON
