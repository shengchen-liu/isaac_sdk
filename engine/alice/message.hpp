...
struct SightMessage : public MessageBase {
  Json json;
  bool is_canvas_with_background = false;
};
...
class ProtoMessageBase : public MessageBase {
 public:
  ...
  uint64_t proto_id() const { return proto_id_;}
 ...
 protected:
  uint64_t proto_id_;
  std::unique_ptr<::capnp::SegmentArrayMessageReader> capnp_reader_;
};
