...
# It comes preinstalled with jetpack 4.2
...
cc_library(
    ...
    srcs = [
        ...
        "usr/lib/aarch64-linux-gnu/libnvinfer_plugin.so.5",
        "usr/lib/aarch64-linux-gnu/libnvinfer_plugin.so.5.0.6",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser.so",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser.so.0",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser.so.0.1.0",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser_runtime.so",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser_runtime.so.0",
        "usr/lib/aarch64-linux-gnu/libnvonnxparser_runtime.so.0.1.0",
        "usr/lib/aarch64-linux-gnu/libnvparsers.so",
        "usr/lib/aarch64-linux-gnu/libnvparsers.so.5",
        "usr/lib/aarch64-linux-gnu/libnvparsers.so.5.0.6",
    ],
    hdrs = [
